...
class ApiRequest {
  ...
  static get = (route: any) => (payload: any) =>
    ApiRequest.request('GET', route, payload);

  static put = (route: any) => (payload: any) =>
    ApiRequest.request('PUT', route, payload);

  static post = (route: any) => (payload: any) =>
    ApiRequest.request('POST', route, payload);

  static delete = (route: any) => (payload: any) =>
    ApiRequest.request('DELETE', route, payload);

  static patch = (route: any) => (payload: any) =>
